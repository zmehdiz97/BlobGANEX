...
class Config:
    ...
    output_dir = 'experiments/style_structure/lambda01bis'
    real_images = True
    bs = 6
    ...
    load_inversion=True
    inversions_path = 'shared_files/validation_rec_reproducible.pt'
...
class BlobEX():
    ...
    def inv_optim(self, im_tar, blob_enc):
        ...
        for step in pbar:
            ...
            loss = loss_pips + 0.1*loss_l2 + 0.1*loss_prox #+ 0.1*decision_loss
    ...
    def cf_optim(self, metadata, images, im_tar):
        ...
        λ_prox = 0.1 #0.5 2 5 10 0.1 0 20 50
